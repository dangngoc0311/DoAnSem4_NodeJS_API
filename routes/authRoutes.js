...
router.post('/users/posts/:id', async (req, res) => {
    try {
        ...
        for (const postData of posts) { // Change the variable name to 'postData'
            const {
                userId,
                post: postContent, // Rename the 'post' variable to 'postContent'
                postImg,
                likes,
                comments,
                createdAt,
            } = postData; // Use 'postData' instead of 'post'
            ...
            list.push({
                id: postData._id, // Use 'postData' instead of 'post'
                userId,
                userName,
                userImg: `${user.userImg}`,
                postTime: `${postData.createdAt}`,
                post: postContent, // Use 'postContent' instead of 'post'
                postImg,
                liked: liked,
                likes,
                comments,
